...
<div class="mb-4">
    <h4 class="fw-bold mb-0">Tambah Jenis Layanan Baru</h4>
    ...
    <div class="card-body p-4">
        ...
        <form action="/layanan/store" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('nama_layanan')) ? 'is-invalid' : '' ?>" id="nama_layanan" name="nama_layanan" value="<?= old('nama_layanan') ?>" placeholder="Contoh: Cuci Setrika (Komplit)">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" class="form-control <?= (isset($validation) && $validation->hasError('harga_per_kg')) ? 'is-invalid' : '' ?>" id="harga_per_kg" name="harga_per_kg" value="<?= old('harga_per_kg') ?>" placeholder="8000">
                    </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control <?= (isset($validation) && $validation->hasError('estimasi_jam')) ? 'is-invalid' : '' ?>" id="estimasi_jam" name="estimasi_jam" value="<?= old('estimasi_jam', 24) ?>" placeholder="24">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Jelaskan detail cakupan layanan laundry..."><?= old('deskripsi') ?></textarea>
            </div>

            <div class="d-flex justify-content-end gap-2">
                <a href="/layanan" class="btn btn-secondary-premium">Batal</a>
                <button type="submit" class="btn btn-premium">Simpan Layanan</button>
            </div>
        </form>
    </div>
</div>
