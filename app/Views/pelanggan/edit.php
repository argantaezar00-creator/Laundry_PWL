    ...
    <div class="card-body p-4">
        ...
        <form action="/pelanggan/update/<?= $pelanggan['id'] ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= old('nama', $pelanggan['nama']) ?>" placeholder="Contoh: Ahmad Fauzi">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('telepon')) ? 'is-invalid' : '' ?>" id="telepon" name="telepon" value="<?= old('telepon', $pelanggan['telepon']) ?>" placeholder="Contoh: 081234567890">
                <div class="invalid-feedback">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control <?= (isset($validation) && $validation->hasError('alamat')) ? 'is-invalid' : '' ?>" id="alamat" name="alamat" rows="4" placeholder="Tulis alamat penjemputan/pengantaran pakaian..."><?= old('alamat', $pelanggan['alamat']) ?></textarea>
                <div class="invalid-feedback">
